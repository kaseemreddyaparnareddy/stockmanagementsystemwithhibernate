...
public class ManagerController {
	...
	public void managerController() {
		do {
			...
			case 3:
				...
				try {
					boolean isChanged = managerService.changePassword(id1, oldPassword, newPassword);
					if (isChanged) {
	...
	public void managerLogin() {
		...
		try {
			ManagerBean login = managerService.managerLogin(managerEmailId, managerPassword);
			if (login != null) {
				managerController();
			}
		} catch (StockManagementSystemExceptions smse) {
